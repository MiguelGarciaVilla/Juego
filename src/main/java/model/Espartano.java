...
public class Espartano extends Jugador {
    public Espartano(String id, String usuario, int nivelDePoder, int vida, Objeto objeto) {
        super(id, usuario, nivelDePoder, vida, TipoJugador.ESPARTANO, objeto);
    }
